...
#define DUE_LEFT_STRIP_PIN 6
#define DUE_RIGHT_STRIP_PIN 7
...
Adafruit_NeoPixel left_strip = Adafruit_NeoPixel(60 * 4, DUE_LEFT_STRIP_PIN, NEO_GRB + NEO_KHZ800);
Adafruit_NeoPixel right_strip = Adafruit_NeoPixel(60 * 4, DUE_RIGHT_STRIP_PIN, NEO_GRB + NEO_KHZ800);
